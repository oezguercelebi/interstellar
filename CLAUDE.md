...
- Triplicated variant-arg shape (`codegenWorkflow.ts:8`, `codegen.ts:94`, `projects.ts:80`)
...
- `buildInstructions` compat shim (`convex/agents/prompt.ts:189`) + its 2 tests — deletable
